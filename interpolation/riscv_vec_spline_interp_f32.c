...
void riscv_vec_spline_interp_f32(riscv_vec_spline_interp_f32_t * FUNC_RESTRICT instance, const float32_t * FUNC_RESTRICT src, float32_t * FUNC_RESTRICT dst, uint32_t size)
{

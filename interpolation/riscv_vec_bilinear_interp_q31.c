...
void riscv_vec_bilinear_interp_q31(riscv_vec_bilinear_interp_q31_t * FUNC_RESTRICT instance,
                                   q31_t * FUNC_RESTRICT src_x, q31_t * FUNC_RESTRICT src_y, q31_t * FUNC_RESTRICT dst, uint32_t size)
{
    ...
    const int32_t COE_Q31_MAX = 0x7FFFFFFF;
    ...
    for(uint32_t cnt = 0; cnt < size; cnt++)
    {
        ...
        rI = ((in_x & (q31_t)COE_UPPER_Q12) >> 20);

        /* Input is in 12.20 format */
        /* 12 bits for the table index */
        /* Index value calculation */
        cI = ((in_y & (q31_t)COE_UPPER_Q12) >> 20);
        ...
        else
        {
            ...
            out = ((q31_t) (((q63_t) x1  * (COE_Q31_MAX - xfract)) >> 32));
            acc = ((q31_t) (((q63_t) out * (COE_Q31_MAX - yfract)) >> 32));

            /* x2 * (xfract) * (1-yfract)  in 3.29(q29) and adding to acc */
            out = ((q31_t) ((q63_t) x2 * (COE_Q31_MAX - yfract) >> 32));
            acc += ((q31_t) ((q63_t) out * (xfract) >> 32));

            /* y1 * (1 - xfract) * (yfract)  in 3.29(q29) and adding to acc */
            out = ((q31_t) ((q63_t) y1 * (COE_Q31_MAX - xfract) >> 32));

...
void riscv_vec_bilinear_interp_f16(riscv_vec_bilinear_interp_f16_t * FUNC_RESTRICT instance,
                                   float16_t * FUNC_RESTRICT src_x, float16_t * FUNC_RESTRICT src_y, float16_t * FUNC_RESTRICT dst, uint32_t size)
{
    ...
    const uint32_t rows = instance->row;
    const uint32_t cols = instance->col;

...
void riscv_vec_linear_interp_f16(riscv_vec_linear_interp_f16_t * FUNC_RESTRICT instance, float16_t * FUNC_RESTRICT src, float16_t * FUNC_RESTRICT dst, uint32_t size)
{

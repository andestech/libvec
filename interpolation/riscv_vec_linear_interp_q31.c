...
void riscv_vec_linear_interp_q31(riscv_vec_linear_interp_q31_t * FUNC_RESTRICT instance, q31_t * FUNC_RESTRICT src, q31_t * FUNC_RESTRICT dst, uint32_t size)
{
    ...
    for(uint32_t cnt = 0; cnt < size; cnt++)
    {
        ...
        else
        {
            ...
            y = ((q31_t) ((q63_t) y0 * (COE_Q31_MAX - fract) >> 32));

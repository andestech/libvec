...
void riscv_vec_spafir_f32(riscv_vec_spafir_f32_t * FUNC_RESTRICT instance, float32_t * FUNC_RESTRICT src,
                          float32_t * FUNC_RESTRICT dst, float32_t * FUNC_RESTRICT buf, uint32_t size)
{
    ...
    nds_cirwrite_f32((int32_t *) py, delsize, &instance->index, 1, (int32_t *) src, 1, size);
    ...
    py = state;
    nds_cirread_f32((int32_t *) py, delsize, &rinx, 1, (int32_t *) pb, (int32_t *) pb, size, 1, size);

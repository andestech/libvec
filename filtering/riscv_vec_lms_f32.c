...
void riscv_vec_lms_f32(const riscv_vec_lms_f32_t * FUNC_RESTRICT instance, float32_t *  FUNC_RESTRICT src, float32_t * FUNC_RESTRICT ref,
                       float32_t * FUNC_RESTRICT dst, float32_t * FUNC_RESTRICT err, uint32_t size)
{

...
/**
 * @brief Function for the q31 Upsampling FIR filter.
...
void riscv_vec_upsplfir_q31(const riscv_vec_upsplfir_q31_t * FUNC_RESTRICT instance, q31_t * FUNC_RESTRICT src,

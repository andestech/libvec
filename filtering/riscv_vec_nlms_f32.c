...
void riscv_vec_nlms_f32(riscv_vec_nlms_f32_t * FUNC_RESTRICT instance,
                        float32_t * FUNC_RESTRICT src,
                        float32_t * FUNC_RESTRICT ref,
                        float32_t * FUNC_RESTRICT dst,
                        float32_t * FUNC_RESTRICT err,
                        uint32_t size)
{

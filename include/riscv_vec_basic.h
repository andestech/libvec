 ...
 * @return none.
 */
int riscv_vec_clip_f32(float32_t *dst, float32_t *src, float32_t low, float32_t high, uint32_t count);
 ...
 * @return none.
 */
int riscv_vec_clip_q31(q31_t *dst, q31_t *src, q31_t low, q31_t high, uint32_t count);
 ...
 * @return none.
 */
int riscv_vec_clip_q15(q15_t *dst, q15_t *src, q15_t low, q15_t high, uint32_t count);
 ...
 * @return none.
 */
int riscv_vec_clip_q7(q7_t *dst, q7_t *src, q7_t low, q7_t high, uint32_t count);
...
#if defined (__riscv_zfh)
/**
 * @brief Vector division function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src1 pointer of the first input vector
 * @param[in] src2 pointer of the second input vector
...
#if defined (__riscv_zfh)
/**
 * @brief Vector divide constant function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src pointer of the input vector
 * @param[in] cst constant value with data type of float16_t
 ...
 * @return RISCV_VEC_OK
 */
int riscv_vec_divc_f16(float16_t *dst, float16_t *src, const float16_t cst, uint32_t count);
#endif
...
/**
 * @brief Vector multiply and add function for q7
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src1 pointer of the first input vector
 * @param[in] src2 pointer of the second input vector
 ...
 * @return RISCV_VEC_OK
 */
int riscv_vec_madd_q7(q7_t *dst, q7_t *src1, q7_t *src2, uint32_t count);

/**
 * @brief Vector multiply and add function for q15
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src1 pointer of the first input vector
 * @param[in] src2 pointer of the second input vector
 ...
 * @return RISCV_VEC_OK
 */
int riscv_vec_madd_q15(q15_t *dst, q15_t *src1, q15_t *src2, uint32_t count);

/**
 * @brief Vector multiply and add function for q31
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src1 pointer of the first input vector
 * @param[in] src2 pointer of the second input vector
 ...
 * @return RISCV_VEC_OK
 */
int riscv_vec_madd_q31(q31_t *dst, q31_t *src1, q31_t *src2, uint32_t count);

/**
 * @brief Vector multiply and add function for u8
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src1 pointer of the first input vector
 * @param[in] src2 pointer of the second input vector
 ...
 * @return RISCV_VEC_OK
 */
int riscv_vec_madd_u8(u8_t *dst, u8_t *src1, u8_t *src2, uint32_t count);

/**
 * @brief Vector multiply and add function for u8xu16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src1 pointer of the first input vector
 * @param[in] src2 pointer of the second input vector
 ...
 * @return RISCV_VEC_OK
 */
int riscv_vec_madd_u8_u16(u16_t *dst, u8_t *src1, u8_t *src2, uint32_t count);

#if defined (__riscv_zfh)
/**
 * @brief Vector multiply and add function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src1 pointer of the first input vector
 * @param[in] src2 pointer of the second input vector
 ...
 * @return RISCV_VEC_OK
 */
int riscv_vec_madd_f16(float16_t *dst, float16_t *src1, float16_t *src2, uint32_t count);
#endif
...
#if defined (__riscv_zfh)
/**
 * @brief Vector multiply and add constant function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src pointer of the input vector
 * @param[in] cst constant value with data type of float16_t
 ...
 * @return RISCV_VEC_OK
 */
int riscv_vec_maddc_f16(float16_t *dst, float16_t *src, const float16_t cst, uint32_t count);
#endif
...
#if defined (__riscv_zfh)
/**
 * @brief Vector subtract constant function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src pointer of the input vector
 * @param[in] cst constant value with data type of float16_t
 ...
 * @return RISCV_VEC_OK
 */
int riscv_vec_subc_f16(float16_t *dst, float16_t *src, const float16_t cst, uint32_t count);
#endif
...
#if defined (__riscv_zfh)
/**
 * @brief Constant subtract vector function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src pointer of the input vector
 * @param[in] cst constant value with data type of float16_t
 ...
 * @return RISCV_VEC_OK
 */
int riscv_vec_rsubc_f16(float16_t *dst, float16_t *src, const float16_t cst, uint32_t count);
#endif
...
#if defined (__riscv_zfh)
/**
 * @brief Vector negate function for f16
 * @param[out]      dst pointer of the output vector
 * @param[in]       src pointer of the input vector
 * @param[in]       count number of elements to be processed
 * @return RISCV_VEC_OK
...
/**
 * @defgroup basic_abs Absolute Difference Functions
 ...
 * one-by-one into a destination vector.
 *
 * Andes vec library supports distinct absolute difference functions for the following data
 * types: F64, F32, F16, Q31, Q15, Q7 and U8. These functions are introduced in the subsections below.
 */
 ...
 * @return none.
 */
void riscv_vec_absdiff_f32(float32_t *src1, float32_t *src2, float32_t *dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_absdiff_f64(float64_t *src1, float64_t *src2, float64_t *dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_absdiff_q7(q7_t *src1, q7_t *src2, q7_t *dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_absdiff_q15(q15_t *src1, q15_t *src2, q15_t *dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_absdiff_q31(q31_t *src1, q31_t *src2, q31_t *dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_absdiff_u8(u8_t *src1, u8_t *src2, u8_t *dst, uint32_t size);
 ...
 * This function is only supported by toolchains with the HW FPU support. Also, you will need to apply the option “-mzfh” both in compiler and linker flags for applications that use this function. For details about the linking option “-mzfh”, please refer to Section 1.1.
 */
void riscv_vec_absdiff_f16(float16_t *src1, float16_t *src2, float16_t *dst, uint32_t size);
#endif
/** @} basic_absdiff */
 ...
 *
 * Andes vec library supports distinct fixed point division functions for Q15 and Q31 data types.
 ...
 * @return none.
 */
void riscv_vec_divide_q31(q31_t *numerator, q31_t *denominator, q31_t *quotient, int16_t *shift, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_divide_q15(q15_t *numerator, q15_t *denominator, q15_t *quotient, int16_t *shift, uint32_t size);
/** @} basic_div_q */
/** @} basic */

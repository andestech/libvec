...
#ifndef __RISCV_VEC_WINDOW_H__
#define __RISCV_VEC_WINDOW_H__
 ...
 *
 * Andes vector library supports functions for the following data types: F32 and F64. These functions are described in the subsections below.
 */
/**
 ...
 * @return none.
 */
void riscv_vec_win_welch_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_welch_f64(float64_t * dst, uint32_t size);
/** @} win_welch */
 ...
 * @return none.
 */
void riscv_vec_win_bartlett_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_bartlett_f64(float64_t * dst, uint32_t size);
/** @} win_bartlett */
 ...
 * @return none.
 */
void riscv_vec_win_hamming_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_hanning_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_nuttall3_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_nuttall3_f64(float64_t * dst, uint32_t size);
/** @} win_nuttall3 */
 ...
 * @return none.
 */
void riscv_vec_win_nuttall3a_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_nuttall3a_f64(float64_t * dst, uint32_t size);
/** @} win_nuttall3a */
 ...
 * @return none.
 */
void riscv_vec_win_nuttall3b_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_nuttall3b_f64(float64_t * dst, uint32_t size);
/** @} win_nuttall3b */
 ...
 * @return none.
 */
void riscv_vec_win_nuttall4_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_nuttall4_f64(float64_t * dst, uint32_t size);
/** @} win_nuttall4 */
 ...
 * @return none.
 */
void riscv_vec_win_nuttall4a_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_nuttall4a_f64(float64_t * dst, uint32_t size);
/** @} win_nuttall4a */
 ...
 * @return none.
 */
void riscv_vec_win_nuttall4b_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_nuttall4b_f64(float64_t * dst, uint32_t size);
/** @} win_nuttall4b */
 ...
 * @return none.
 */
void riscv_vec_win_nuttall4c_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_nuttall4c_f64(float64_t * dst, uint32_t size);
/** @} win_nuttall4c */
 ...
 * @return none.
 */
void riscv_vec_win_blackman_harris_92db_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_blackman_harris_92db_f64(float64_t * dst, uint32_t size);
/** @} win_blackman */
 ...
 * @return none.
 */
void riscv_vec_win_hft95_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_hft95_f64(float64_t * dst, uint32_t size);
/** @} win_hft95 */
 ...
 * @return none.
 */
void riscv_vec_win_hft90d_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_hft90d_f64(float64_t * dst, uint32_t size);
/** @} win_hft90d */
 ...
 * @return none.
 */
void riscv_vec_win_hft116d_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_hft116d_f64(float64_t * dst, uint32_t size);
/** @} win_hft116d */
 ...
 * @return none.
 */
void riscv_vec_win_hft144d_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_hft144d_f64(float64_t * dst, uint32_t size);
/** @} win_hft144d */
 ...
 * @return none.
 */
void riscv_vec_win_hft169d_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_hft169d_f64(float64_t * dst, uint32_t size);
/** @} win_hft169d */
 ...
 * @return none.
 */
void riscv_vec_win_hft196d_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_hft196d_f64(float64_t * dst, uint32_t size);
/** @} win_hft196d */
 ...
 * @return none.
 */
void riscv_vec_win_hft223d_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_hft223d_f64(float64_t * dst, uint32_t size);
/** @} win_hft223d */
 ...
 * @return none.
 */
void riscv_vec_win_hft248d_f32(float32_t * dst, uint32_t size);
 ...
 * @return none.
 */
void riscv_vec_win_hft248d_f64(float64_t * dst, uint32_t size);

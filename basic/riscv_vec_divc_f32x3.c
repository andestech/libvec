...
int riscv_vec_divc_f32x3(riscv_vec_f32x3_t * FUNC_RESTRICT dst, riscv_vec_f32x3_t * FUNC_RESTRICT src, const riscv_vec_f32x3_t * FUNC_RESTRICT cst, uint32_t count)
{

...
int riscv_vec_maddc_f32x2(riscv_vec_f32x2_t * FUNC_RESTRICT dst, riscv_vec_f32x2_t * FUNC_RESTRICT src, const riscv_vec_f32x2_t * FUNC_RESTRICT cst, uint32_t count)
{

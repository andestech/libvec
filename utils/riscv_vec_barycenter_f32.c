...
void riscv_vec_barycenter_f32(const float32_t * FUNC_RESTRICT src, const float32_t * FUNC_RESTRICT weights, float32_t *out, uint32_t numofvec, uint32_t dimofvec)
{
    float32_t acc = 0.0f;
    uint32_t cntdim;

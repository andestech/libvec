...
int riscv_vec_rmmat_inv_f32(float32_t * FUNC_RESTRICT src, float32_t * FUNC_RESTRICT dst, uint32_t size)
{
    if (size == 0)
    {
        return NDSV_FAIL;

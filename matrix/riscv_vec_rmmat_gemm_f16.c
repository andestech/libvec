...
extern int riscv_vec_mulc_f16(float16_t * FUNC_RESTRICT dst, float16_t * FUNC_RESTRICT src, const float16_t cst, uint32_t count);

/* function description */
int riscv_vec_rmmat_gemm_f16(const MM_TYPE* FUNC_RESTRICT src1, const MM_TYPE* FUNC_RESTRICT src2, MM_TYPE* FUNC_RESTRICT dst,

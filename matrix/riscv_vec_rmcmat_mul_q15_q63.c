...
int riscv_vec_rmcmat_mul_q15_q63(const MM_TYPE* FUNC_RESTRICT src1, const MM_TYPE* FUNC_RESTRICT src2, MM_TYPE_VQ* FUNC_RESTRICT dst, uint32_t row, uint32_t col, uint32_t col2)
{

...
int riscv_vec_rmmat_gemm_q15_q63(const MM_TYPE * FUNC_RESTRICT src1, const MM_TYPE * FUNC_RESTRICT src2, MM_TYPE_VQ * FUNC_RESTRICT dst,
                                ...
                                uint32_t row, uint32_t col, uint32_t col2, int32_t shift)
{
     ...
     */
    vec_gemm_purec_original_vq(src1, src2, dst, alpha, beta, row, col, col2, shift1);// (q30 * q15 + q15 * q30) >> shift1
    return NDSV_OK;
}

...
int riscv_vec_rmcmat_gemm_q7_q31(const MM_TYPE * FUNC_RESTRICT src1, const MM_TYPE * FUNC_RESTRICT src2, MM_TYPE_VQ * FUNC_RESTRICT dst,
                                ...
                                uint32_t row, uint32_t col, uint32_t col2, int32_t shift)
{
     ...
     */
    vec_cgemm_purec_original_vq(src1, src2, dst, alpha, beta, row, col, col2, shift + 7);// (q14 * q7 + q7 * q14) >> shift1
    return NDSV_OK;
}

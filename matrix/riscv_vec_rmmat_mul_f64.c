...
int riscv_vec_rmmat_mul_f64(const MM_TYPE * FUNC_RESTRICT src1, const MM_TYPE * FUNC_RESTRICT src2, MM_TYPE * FUNC_RESTRICT dst, uint32_t row, uint32_t col, uint32_t col2)
{

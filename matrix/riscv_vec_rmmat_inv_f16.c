...
int riscv_vec_rmmat_inv_f16(float16_t * FUNC_RESTRICT src, float16_t * FUNC_RESTRICT dst, uint32_t size)
{
    if (size == 0)
    {
        return NDSV_FAIL;

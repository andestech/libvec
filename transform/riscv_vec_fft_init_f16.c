...
static void riscv_vec_create_twiddle_segment_f16 (riscv_vec_cpx_f16_t * FUNC_RESTRICT twiddles,
        const q31_t mstride,
        const q31_t fstride,
        const q31_t radix,
        const q31_t nfft)
...
static riscv_vec_cpx_f16_t* riscv_vec_create_twiddle_f16 (riscv_vec_cpx_f16_t * FUNC_RESTRICT twiddles,
        const q31_t * FUNC_RESTRICT factors,
        const q31_t nfft )
{
...
/**
 * cfft_f16 cifft_f16 initial and free function
 */
...
/**
 * cfft2d_f16 cifft2d_f16 initial and free function
 */
...
/**
 * rfft_f16 rifft_f16 initial and free function
 */
...
/**
 * rfft2d_f16 rifft2d_f16 initial and free function
 */

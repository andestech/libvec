...
static void riscv_vec_bfly_q15 (riscv_vec_cpx_q15_t * FUNC_RESTRICT Fout,
                                ...
                                q31_t scaled_flag)
{
    ...
    riscv_vec_cpx_q15_t *out_val = NULL ;
    riscv_vec_cpx_q15_t *in_val = NULL  ;
    riscv_vec_cpx_q15_t *out_next = NULL  ;
    riscv_vec_cpx_q15_t tmp_cal_1, tmp_cal_2, tmp_cal_wp;
    uint16_t q_shift_m  = 0;
    if(stage_num % 2 ==0)
    {
        out_val = buffer;
        out_next = Fout;
    ...
    for(tmp_p =0; tmp_p < input_m ; tmp_p++)
    {
        ...
        for( tmp_q = 0 ; tmp_q < step; tmp_q++)
        {
            ...
            out_val[tmp_q + step*(2*tmp_p + 1)].r = (q15_t)( ( (NDSV_F2I16_SAMPPROD)tmp_r*tmp_cal_wp.r - (NDSV_F2I16_SAMPPROD)tmp_i*tmp_cal_wp.i) >> (15) );
            out_val[tmp_q + step*(2*tmp_p + 1)].i = (q15_t)( ( (NDSV_F2I16_SAMPPROD)tmp_r*tmp_cal_wp.i + (NDSV_F2I16_SAMPPROD)tmp_i*tmp_cal_wp.r) >> (15) );
...
static void riscv_vec_ibfly_q15 (riscv_vec_cpx_q15_t * FUNC_RESTRICT Fout,
                                 riscv_vec_cpx_q15_t * FUNC_RESTRICT Fin,
                                 q31_t * FUNC_RESTRICT factors,
                                 riscv_vec_cpx_q15_t * FUNC_RESTRICT twiddles,
                                 riscv_vec_cpx_q15_t * FUNC_RESTRICT buffer,
...
{
    // pure C version
    q15_t input_m = factors[SIZE_FIRST_STAGE];
    q15_t step = 1;
    q15_t stage_num = factors[OUT_INDEX];
    q15_t stage_idx = 0;
    q15_t tmp_r, tmp_i;
    q15_t tmp_q = 0, tmp_p = 0 ;
    uint16_t q_shift_m = 0;
...
// static
__attribute__((noinline)) void riscv_vec_rfft_split_q15 (riscv_vec_cpx_q15_t * FUNC_RESTRICT dst,
        ...
        q31_t scaled_flag)
{
    ...
    riscv_vec_cpx_q15_t *out_val = dst;
    const riscv_vec_cpx_q15_t *in_val  = src;
    q31_t size = ncfft;
    riscv_vec_cpx_q15_t tmp_cal_1, tmp_cal_2, tmp_cal_wp;
    NDSV_F2I16_SAMPPROD tmp_1 = 0, tmp_2 = 0, tmp_3 = 0, tmp_4 = 0;
    ...
    for( tmp_q = 1 ; tmp_q <= size/2; tmp_q++)
    {
        ...
        tmp_1 = ((NDSV_F2I16_SAMPPROD)tmp_cal_2.r*(NDSV_F2I16_SAMPPROD)tmp_cal_wp.i) >> (15);
        tmp_2 = ((NDSV_F2I16_SAMPPROD)tmp_cal_2.i*(NDSV_F2I16_SAMPPROD)tmp_cal_wp.r) >> (15);
        tmp_3 = ((NDSV_F2I16_SAMPPROD)tmp_cal_2.r*(NDSV_F2I16_SAMPPROD)tmp_cal_wp.r) >> (15);
        tmp_4 = ((NDSV_F2I16_SAMPPROD)tmp_cal_2.i*(NDSV_F2I16_SAMPPROD)tmp_cal_wp.i) >> (15);
        out_val[tmp_q].r = (tmp_cal_1.r - ( (q15_t)(tmp_1) + (q15_t)(tmp_2))) >> 1;
        out_val[tmp_q].i = (tmp_cal_1.i + ( (q15_t)(tmp_3) - (q15_t)(tmp_4))) >> 1;
        out_val[size-tmp_q].r = (tmp_cal_1.r + ((q31_t)(tmp_1) +(q31_t) (tmp_2))) >> 1;
        out_val[size-tmp_q].i = (((q15_t)(tmp_3)- (q15_t)(tmp_4))-tmp_cal_1.i) >>1;
    }

}

static void riscv_vec_rifft_split_q15 (riscv_vec_cpx_q15_t * FUNC_RESTRICT dst,
                                       const riscv_vec_cpx_q15_t * FUNC_RESTRICT src,
                                       riscv_vec_cpx_q15_t * FUNC_RESTRICT twiddles,
                                       q31_t ncfft,
                                       q31_t scaled_flag)
{
    // in this part, output shift will be 2 (div by 4)
    riscv_vec_cpx_q15_t *out_val = dst;
    const riscv_vec_cpx_q15_t *in_val  = src;
    q15_t size = ncfft;
    riscv_vec_cpx_q15_t tmp_cal_1, tmp_cal_2, tmp_cal_wp;
    q15_t *wp_tbl_rifft_r = NULL, *wp_tbl_rifft_i = NULL;
    NDSV_F2I16_SAMPPROD tmp_1 = 0, tmp_2 = 0, tmp_3 = 0, tmp_4 = 0;
    q15_t tmp_q = 0, m = 0 ;
    if(scaled_flag)
    {
    ...
    for( tmp_q = 1 ; tmp_q <= size/2; tmp_q++)
    {
        ...
        tmp_3 = ((NDSV_F2I16_SAMPPROD)tmp_cal_2.r*(NDSV_F2I16_SAMPPROD)tmp_cal_wp.r) >> (15);
        tmp_4 = ((NDSV_F2I16_SAMPPROD)tmp_cal_2.i*(NDSV_F2I16_SAMPPROD)tmp_cal_wp.i) >> (15);
        out_val[tmp_q].r = (tmp_cal_1.r - ( (q15_t)(tmp_1) + (q15_t)(tmp_2)))   ;
        out_val[tmp_q].i = (tmp_cal_1.i + ( (q15_t)(tmp_3) - (q15_t)(tmp_4)))   ;
        out_val[size-tmp_q].r = (tmp_cal_1.r + ((q15_t)(tmp_1) +(q15_t) (tmp_2)))  ;
        out_val[size-tmp_q].i = (((q15_t)(tmp_3)- (q15_t)(tmp_4))-tmp_cal_1.i)     ;
    }
                         ...
                         q31_t scaled_flag)
{
    ...
    {
        if (inverse_fft)
            riscv_vec_ibfly_q15 (out, in, cfg->factors, cfg->twiddles, cfg->buffer, scaled_flag);
        else
            riscv_vec_bfly_q15 (out, in, cfg->factors, cfg->twiddles, cfg->buffer, scaled_flag);
 ...
 */
void  riscv_vec_rfft_q15 (riscv_vec_cpx_q15_t * FUNC_RESTRICT out,
                         q15_t * FUNC_RESTRICT in,
                         riscv_vec_rfft_cfg_q15_t cfg,
                         q31_t scaled_flag)
{
    if( cfg != NULL)
    {
        riscv_vec_cpx_q15_t * tmpbuf = cfg->buffer;

        riscv_vec_bfly_q15 (tmpbuf, (riscv_vec_cpx_q15_t*) in, cfg->factors, cfg->twiddles, out, scaled_flag);
        riscv_vec_rfft_split_q15 (out, tmpbuf, cfg->super_twiddles, cfg->ncfft, scaled_flag);
                          ...
                          q31_t scaled_flag)
{
    if( cfg != NULL)
    {
        ...
        riscv_vec_ibfly_q15 ( (riscv_vec_cpx_q15_t*) out, tmpbuf1, cfg->factors, cfg->twiddles, tmpbuf2, scaled_flag);
                                ...
                                q31_t scaled_flag)
{
    ...
    riscv_vec_cpx_q15_t   scratch_in_radix8[8];
    riscv_vec_cpx_q15_t   scratch_in[8];
    riscv_vec_cpx_q15_t   scratch_out[8];
    riscv_vec_cpx_q15_t   scratch[16];
    riscv_vec_cpx_q15_t   scratch_tw[6];

    riscv_vec_cpx_q15_t   *Fin1, *Fin2, *Fout1, *Fout2;
    riscv_vec_cpx_q15_t   *Fout_ls = Fout;
    riscv_vec_cpx_q15_t   *Ftmp;
    riscv_vec_cpx_q15_t   *tw, *tw1, *tw2;
    const q31_t TW_81 = 23169;
    const q31_t TW_81N = -23169;
    ...
    if (N == 8)   // length of FFT is 2^n (n is odd)
    {
        ...
        for (f_count = 0; f_count < fstride; f_count ++)
        {
            ...
            scratch[3].r = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) (scratch_in[3].r + scratch_in[3].i) * TW_81) >> NDSV_F2I16_SHIFT);
            scratch[3].i = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) (scratch_in[3].i - scratch_in[3].r) * TW_81) >> NDSV_F2I16_SHIFT);
            ...
            scratch[7].r = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) (scratch_in[7].r - scratch_in[7].i) * TW_81N) >> NDSV_F2I16_SHIFT);
            scratch[7].i = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) (scratch_in[7].i + scratch_in[7].r) * TW_81N) >> NDSV_F2I16_SHIFT);
    ...
    else if (N == 4)   // length of FFT is 2^n (n is even) >= 4
    {
        ...
        for (f_count = fstride; f_count ; f_count --)
        {
            ...
            if (scaled_flag == 1)
            {
                NDSV_F2I16_FIXDIV (scratch_in[0], 4);
                NDSV_F2I16_FIXDIV (scratch_in[1], 4);
                NDSV_F2I16_FIXDIV (scratch_in[2], 4);
                NDSV_F2I16_FIXDIV (scratch_in[3], 4);
            }
    ...
    else if (N == 2) // Length of FFT is 2
    {
        ...
        if (scaled_flag == 1)
        {
            NDSV_F2I16_FIXDIV (scratch_in[0], 2);
            NDSV_F2I16_FIXDIV (scratch_in[1], 2);
        }
    ...
    for (; stage_count > 1 ; stage_count--)
    {
        ...
        for (f_count = 0; f_count < fstride; f_count ++)
        {
            ...
            for (m_count = mstride; m_count ; m_count --)
            {
                ...
                scratch[0] = scratch_in[0];
                scratch[1].r = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) scratch_in[1].r * scratch_tw[0].r
                                           - (NDSV_F2I16_SAMPPROD) scratch_in[1].i * scratch_tw[0].i) >> NDSV_F2I16_SHIFT);
                scratch[1].i = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) scratch_in[1].i * scratch_tw[0].r
                                           + (NDSV_F2I16_SAMPPROD) scratch_in[1].r * scratch_tw[0].i) >> NDSV_F2I16_SHIFT);

                scratch[2].r = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) scratch_in[2].r * scratch_tw[1].r
                                           - (NDSV_F2I16_SAMPPROD) scratch_in[2].i * scratch_tw[1].i) >> NDSV_F2I16_SHIFT);
                scratch[2].i = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) scratch_in[2].i * scratch_tw[1].r
                                           + (NDSV_F2I16_SAMPPROD) scratch_in[2].r * scratch_tw[1].i) >> NDSV_F2I16_SHIFT);

                scratch[3].r = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) scratch_in[3].r * scratch_tw[2].r
                                           - (NDSV_F2I16_SAMPPROD) scratch_in[3].i * scratch_tw[2].i) >> NDSV_F2I16_SHIFT);
                scratch[3].i = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) scratch_in[3].i * scratch_tw[2].r
                                           + (NDSV_F2I16_SAMPPROD) scratch_in[3].r * scratch_tw[2].i) >> NDSV_F2I16_SHIFT);
                                 ...
                                 q31_t scaled_flag)
{
    ...
    if (N == 8)   // length of FFT is 2^n (n is odd)
    {
        ...
        for (f_count = 0; f_count < fstride; f_count ++)
        {
            ...
            scratch_in[0].r = scratch_in_radix8[0].r + scratch_in_radix8[fstride * 4].r;
            scratch_in[0].i = scratch_in_radix8[0].i + scratch_in_radix8[fstride * 4].i;
            scratch_in[1].r = scratch_in_radix8[0].r - scratch_in_radix8[fstride * 4].r;
            scratch_in[1].i = scratch_in_radix8[0].i - scratch_in_radix8[fstride * 4].i;
            scratch_in[2].r = scratch_in_radix8[fstride].r + scratch_in_radix8[fstride * 5].r;
            scratch_in[2].i = scratch_in_radix8[fstride].i + scratch_in_radix8[fstride * 5].i;
            scratch_in[3].r = scratch_in_radix8[fstride].r - scratch_in_radix8[fstride * 5].r;
            scratch_in[3].i = scratch_in_radix8[fstride].i - scratch_in_radix8[fstride * 5].i;
            scratch_in[4].r = scratch_in_radix8[fstride * 2].r + scratch_in_radix8[fstride * 6].r;
            scratch_in[4].i = scratch_in_radix8[fstride * 2].i + scratch_in_radix8[fstride * 6].i;
            scratch_in[5].r = scratch_in_radix8[fstride * 2].r - scratch_in_radix8[fstride * 6].r;
            scratch_in[5].i = scratch_in_radix8[fstride * 2].i - scratch_in_radix8[fstride * 6].i;
            scratch_in[6].r = scratch_in_radix8[fstride * 3].r + scratch_in_radix8[fstride * 7].r;
            scratch_in[6].i = scratch_in_radix8[fstride * 3].i + scratch_in_radix8[fstride * 7].i;
            scratch_in[7].r = scratch_in_radix8[fstride * 3].r - scratch_in_radix8[fstride * 7].r;
            scratch_in[7].i = scratch_in_radix8[fstride * 3].i - scratch_in_radix8[fstride * 7].i;
            // radix 4 butterfly with twiddles
...
// static
__attribute__((noinline)) void riscv_vec_rfft_split_q15 (riscv_vec_cpx_q15_t *dst,
        const riscv_vec_cpx_q15_t *src,
        riscv_vec_cpx_q15_t *twiddles,
        q31_t ncfft,
        q31_t scaled_flag)
{
    q31_t k;
    riscv_vec_cpx_q15_t fpnk, fpk, f1k, f2k, tw, tdc;

    tdc.r = src[0].r;
    tdc.i = src[0].i;

    if (scaled_flag)
        NDSV_F2I16_FIXDIV (tdc, 2);
    ...
    for (k = 1; k <= ncfft / 2 ; ++k)
    {
        ...
        if (scaled_flag)
        {
            NDSV_F2I16_FIXDIV (fpk, 2);
            NDSV_F2I16_FIXDIV (fpnk, 2);
        }
        ...
        tw.r = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) f2k.r * (twiddles[k - 1]).r
                           - (NDSV_F2I16_SAMPPROD) f2k.i * (twiddles[k - 1]).i) >> NDSV_F2I16_SHIFT);
        tw.i = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) f2k.r * (twiddles[k - 1]).i
                           + (NDSV_F2I16_SAMPPROD) f2k.i * (twiddles[k - 1]).r) >> NDSV_F2I16_SHIFT);
                                       ...
                                       q31_t scaled_flag)
{
    ...
    q31_t k;
    riscv_vec_cpx_q15_t fk, fnkc, fek, fok, tmp;
    ...
    for (k = 1; k <= ncfft / 2; k++)
    {
        ...
        if (scaled_flag)
        {
            NDSV_F2I16_FIXDIV (fk, 2);
            NDSV_F2I16_FIXDIV (fnkc, 2);
        }
        ...
        fok.r = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) tmp.r * (twiddles[k - 1]).r
                            + (NDSV_F2I16_SAMPPROD) tmp.i * (twiddles[k - 1]).i) >> NDSV_F2I16_SHIFT);
        fok.i = (q15_t) ( ( (NDSV_F2I16_SAMPPROD) tmp.i * (twiddles[k - 1]).r
                            - (NDSV_F2I16_SAMPPROD) tmp.r * (twiddles[k - 1]).i) >> NDSV_F2I16_SHIFT);
...
riscv_vec_cfft_cfg_q15_t riscv_vec_cfft_init_q15 (q31_t nfft)
{
    ...
    u32_t memneeded = sizeof (riscv_vec_cfft_state_q15_t)
                      ...
                      + sizeof (riscv_vec_cpx_q15_t) * (nfft)       /* twiddles */
        ...
        for (; stage_count > 0; stage_count --)
        {
            ...
            for (j = 0; j < mstride; j++)
            {
                for (k = 1; k < cur_radix; k++) // phase = 1 when k = 0
                {
                    ...
                    twiddles[mstride * (k - 1) + j].r = (q15_t) floor (0.5f + NDSV_F2I16_MAX * cos (phase));
                    twiddles[mstride * (k - 1) + j].i = (q15_t) floor (0.5f + NDSV_F2I16_MAX * sin (phase));
                }
            }
...
riscv_vec_rfft_cfg_q15_t riscv_vec_rfft_init_q15 (q31_t nfft)
{
    ...
    u32_t memneeded = sizeof (riscv_vec_rfft_state_q15_t)
                      + sizeof (q31_t) * (NDSV_FACTOR_MAX * 2)    /* factors */
                      + sizeof (riscv_vec_cpx_q15_t) * ncfft           /* twiddles */
                      + sizeof (riscv_vec_cpx_q15_t) * ncfft / 2 /* super twiddles */
    ...
    if (st)
    {
        ...
        for (j = 0; j < ncfft / 2; j++)
        {
            ...
            twiddles->r = (q15_t) floor (0.5f + NDSV_F2I16_MAX * cos (phase));
            twiddles->i = (q15_t) floor (0.5f + NDSV_F2I16_MAX * sin (phase));
            twiddles++;
        }
    }

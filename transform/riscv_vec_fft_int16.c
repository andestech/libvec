...
static void riscv_vec_bfly_q15 (riscv_vec_cpx_q15_t * Fout,
                                riscv_vec_cpx_q15_t   * Fin,
                                q31_t * factors,
                                riscv_vec_cpx_q15_t * twiddles,
                                riscv_vec_cpx_q15_t * buffer,
                                q31_t scaled_flag)
{
    // pure C version
...
static void riscv_vec_ibfly_q15 (riscv_vec_cpx_q15_t * Fout,
                                 riscv_vec_cpx_q15_t   * Fin,
                                 q31_t * factors,
                                 riscv_vec_cpx_q15_t * twiddles,
                                 riscv_vec_cpx_q15_t * buffer,
...
static void riscv_vec_rifft_split_q15 (riscv_vec_cpx_q15_t *dst,
                                       const riscv_vec_cpx_q15_t *src,
                                       riscv_vec_cpx_q15_t *twiddles,
                                       q31_t ncfft,
                                       q31_t scaled_flag)

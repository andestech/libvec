...
static void riscv_vec_bfly_q31 (riscv_vec_cpx_q31_t * Fout,
                                riscv_vec_cpx_q31_t   * Fin,
                                q31_t * factors,
                                riscv_vec_cpx_q31_t * twiddles,
                                riscv_vec_cpx_q31_t * buffer,
                                q31_t scaled_flag)
{
    // pure C version
...
static void riscv_vec_ibfly_q31 (riscv_vec_cpx_q31_t * Fout,
                                 riscv_vec_cpx_q31_t   * Fin,
                                 q31_t * factors,
                                 riscv_vec_cpx_q31_t * twiddles,
                                 riscv_vec_cpx_q31_t * buffer,
...
static void riscv_vec_rfft_split_q31 (riscv_vec_cpx_q31_t *dst,
                                      const riscv_vec_cpx_q31_t *src,
                                      riscv_vec_cpx_q31_t *twiddles,
                                      q31_t ncfft,
                                      q31_t scaled_flag)
{
...
static void riscv_vec_rifft_split_q31 (riscv_vec_cpx_q31_t *dst,
                                       const riscv_vec_cpx_q31_t *src,
                                       riscv_vec_cpx_q31_t *twiddles,
                                       q31_t ncfft,
                                       q31_t scaled_flag)

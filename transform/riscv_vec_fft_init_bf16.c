...
static void riscv_vec_create_twiddle_segment_bf16 (riscv_vec_cpx_bf16_t * FUNC_RESTRICT twiddles,
        const q31_t mstride,
        const q31_t fstride,
        const q31_t radix,
        const q31_t nfft)
...
static riscv_vec_cpx_bf16_t* riscv_vec_create_twiddle_bf16 (riscv_vec_cpx_bf16_t * FUNC_RESTRICT twiddles,
        const q31_t * FUNC_RESTRICT factors,
        const q31_t nfft )
{
...
/**
 * cfft_bf16 cifft_bf16 initial and free function
 */
#if defined (__riscv_zfbfmin)
...
/**
 * cfft2d_bf16 cifft2d_bf16 initial and free function
 */
...
/**
 * rfft_bf16 rifft_bf16 initial and free function
 */
...
/**
 * rfft2d_bf16 rifft2d_bf16 initial and free function
 */

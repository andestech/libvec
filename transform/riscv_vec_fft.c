...
// twiddle = (1.0, 0.0).
void riscv_vec_create_twiddle_segment_f32 (riscv_vec_cpx_f32_t * twiddles,
        const q31_t mstride,
        const q31_t fstride,
        const q31_t radix,
        const q31_t nfft)
...
void riscv_vec_create_twiddle_segment_f64 (riscv_vec_cpx_f64_t * twiddles,
        const q31_t mstride,
        const q31_t fstride,
        const q31_t radix,
        const q31_t nfft)
...
// First column (k == 0)is ignored because phase == 1, and
// twiddle = (1.0, 0.0).
static void riscv_vec_create_twiddle_segment_q31 (riscv_vec_cpx_q31_t * twiddles,
        const q31_t mstride,
        const q31_t fstride,
        const q31_t radix,
        const q31_t nfft)
...
riscv_vec_cpx_q31_t* riscv_vec_create_twiddle_q31 (riscv_vec_cpx_q31_t * twiddles,
        const q31_t * factors,
        const q31_t nfft )
{
    q31_t mstride = 1 ;
...
riscv_vec_cpx_f64_t* riscv_vec_create_twiddle_f64 (riscv_vec_cpx_f64_t * twiddles,
        const q31_t * factors,
        const q31_t nfft )
{

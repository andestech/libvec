...
static inline float32_t vec_cmmat2x2_det_f32(riscv_vec_cmmat2x2_f32_t *mat)
{
    // 2x2 matrix layout
    //  c.x c.x
    //  c.y c.y
...
static inline float32_t vec_cmmat3x3_det_f32(riscv_vec_cmmat3x3_f32_t *mat)
{
    // 3x3 matrix layout
    //  c.x c.x c.x
    //  c.y c.y c.y
    ...
    float32_t out = (mat->c1.x * vec_cmmat2x2_det_f32(&subm11))
                  - (mat->c2.x * vec_cmmat2x2_det_f32(&subm21))
                  + (mat->c3.x * vec_cmmat2x2_det_f32(&subm31));
    return out;
}

static inline float32_t vec_cmmat4x4_det_f32(riscv_vec_cmmat4x4_f32_t * mat)
{
    // 4x4 matrix layout
    //  c.x c.x c.x c.x
    //  c.y c.y c.y c.y
    ...
    return    (mat->c1.x * vec_cmmat3x3_det_f32(&subm11))
            - (mat->c2.x * vec_cmmat3x3_det_f32(&subm21))
            + (mat->c3.x * vec_cmmat3x3_det_f32(&subm31))
            - (mat->c4.x * vec_cmmat3x3_det_f32(&subm41));
}

static inline void vec_cmmat2x2_trans_f32(riscv_vec_cmmat2x2_f32_t * outMat, float32_t m11, float32_t m21, float32_t m12, float32_t m22)
{
    outMat->c1.x = m11;
    outMat->c1.y = m21;
    outMat->c2.x = m12;
...
static inline void vec_cmmat3x3_trans_f32 (riscv_vec_cmmat3x3_f32_t * outMat, float32_t m11, float32_t m21, float32_t m31,
...
static inline void vec_cmmat4x4_trans_f32 (riscv_vec_cmmat4x4_f32_t * outMat, float32_t m11, float32_t m21, float32_t m31, float32_t m41,

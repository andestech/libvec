 ...
 *
 * The buffer dtw_path must be big enough to contain
 * the warping path.
 *
 * dtw_path_length is the number of points in
 * the returned path. The resturned path
 * may be smaller than query + template.
 *
 */
void riscv_vec_dtw_path_f32(const float32_t * FUNC_RESTRICT dtw,

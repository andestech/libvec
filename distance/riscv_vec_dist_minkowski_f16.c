 ...
 *
 */
float16_t riscv_vec_dist_minkowski_f16(const float16_t * FUNC_RESTRICT src1, const float16_t * FUNC_RESTRICT src2, int32_t order, uint32_t size)
{
    float16_t accsum = 0.0f;
    float16_t tmp, tmp2, out;

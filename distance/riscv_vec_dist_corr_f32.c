 ...
 *
 */
float32_t riscv_vec_dist_corr_f32(const float32_t * FUNC_RESTRICT src1, const float32_t * FUNC_RESTRICT src2, uint32_t size)
{
    float32_t mean1 = riscv_vec_mean_f32(src1, size);
    float32_t mean2 = riscv_vec_mean_f32(src2, size);
    riscv_vec_addc_f32((float32_t *)src1, (float32_t *)src1, -mean1, size);
    riscv_vec_addc_f32((float32_t *)src2, (float32_t *)src2, -mean2, size);

...
void riscv_vec_win_hft116d_f64(float64_t * FUNC_RESTRICT dst, uint32_t size)
{
    vec_weighted_sum_of_cos_5(dst, size, 1.0, -1.9575375, 1.4780705, -0.6367431, 0.1228389, -0.0066288);
}

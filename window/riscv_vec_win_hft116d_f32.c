...
void riscv_vec_win_hft116d_f32(float32_t * FUNC_RESTRICT dst, uint32_t size)
{
    vec_weighted_sum_of_cos_5(dst, size, 1.0f, -1.9575375f, 1.4780705f, -0.6367431f, 0.1228389f, -0.0066288f);
}

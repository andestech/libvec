...
void riscv_vec_win_hft95_f32(float32_t * FUNC_RESTRICT dst, uint32_t size)
{
    vec_weighted_sum_of_cos_4(dst, size, 1.0f, -1.9383379f, 1.3045202f, -0.4028270f, 0.0350665f);
}

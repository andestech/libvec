...
void riscv_vec_win_hft90d_f32(float32_t * FUNC_RESTRICT dst, uint32_t size)
{
    vec_weighted_sum_of_cos_4(dst, size, 1.0f, -1.942604f, 1.340318f, -0.440811f, 0.043097f);
}

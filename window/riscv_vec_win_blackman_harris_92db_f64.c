...
void riscv_vec_win_blackman_harris_92db_f64(float64_t * FUNC_RESTRICT dst, uint32_t size)
{
    vec_weighted_sum_of_cos_3(dst, size, 0.35875, -0.48829, 0.14128, -0.01168);
}
